...
@job
def notify_missed_progress_event(progress_event):
    notify_missed_progress_event_slack(progress_event)


@job
def notify_interest_poll_status(interest_poll):
    notify_interest_poll_status_slack(interest_poll)